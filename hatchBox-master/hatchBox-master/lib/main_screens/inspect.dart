...
import 'package:hatch_box/side_screens/review.dart';
...
class DetP extends StatefulWidget {
  const DetP({Key? key,required this.ImgPath,
    ...
    required this.ss, required this.rev,required this.status,required this.rev1,required this.rev2
  }) : super(key: key);
  final String ImgPath, name,discount,mrp,your_price,ls,ss,rev,rev1,rev2,status,cat;
  @override
                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap:(){
            Navigator.of(context).push(MaterialPageRoute(builder: (context){
            return Review(rev: widget.rev,rev2: widget.rev2,rev1: widget.rev1,);
            }));},
                        child: Container(
