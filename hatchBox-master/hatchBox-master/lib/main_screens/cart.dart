...
import 'package:hatch_box/side_screens/payscreen.dart';
...
class CartProd extends StatelessWidget {
  ...
  String mrp, discount, your_price, status,id,long_description,short_description,review,cat,rev1,rev2;
      ...
      child: Stack(children: [
        GestureDetector(
          onTap: (){Navigator.of(context).push(MaterialPageRoute(builder: (context){
            return DetP(ImgPath:ImgPath,name:name ,discount: discount,mrp: mrp,your_price: your_price,ls:long_description,ss: short_description,rev: review,status:status,cat: cat,rev2: rev2,rev1: rev1,);
          }));},
          child: Card(
