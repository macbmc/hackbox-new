                ...
                onTap: (){
                  Navigator.of(context)
                    ...
                    return DetP(ImgPath:snapshotdata!.docs[index]['image'].toString(),discount:snapshotdata!.docs[index]['discount'].toString(),mrp: snapshotdata!.docs[index]['mrp'].toString(),
                      ...
                      rev: snapshotdata!.docs[index]['rev'].toString(),status:snapshotdata!.docs[index]['status'].toString(),cat:snapshotdata!.docs[index]['category '].toString(),rev1: snapshotdata!.docs[index]['rev1'].toString(),rev2: snapshotdata!.docs[index]['rev2'].toString(),);
                  }));
                },
                child: ListTile(
